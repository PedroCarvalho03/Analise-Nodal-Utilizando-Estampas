...
GnInicial = np.zeros([2,2])
InInicial = np.zeros(2)

GnInicial = Estampa.resistor(2,0,1,GnInicial)
InInicial = Estampa.fonteCorrente(0.5,0,1,InInicial)

eAnterior = np.array([0,1])
numIteracoes = 100
tol = 1e-5
